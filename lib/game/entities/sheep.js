...
ig.global.EntitySheep = ig.Entity.extend({
    ...
    update: function() {
        ...
        if (!this.trapped) {
            ...
            else if (this.pos.y < ig.system.height - 75) {
                this.pos.y += this.speed * ig.system.tick;
            }
        }
    ...
    //    ig.music.stop('sheepRunSound');
         //   this.sheepRunSoundPlaying = false;
        this.sheepRunSound.stop();
    ...
    checkRunMovement: function() {
     /*   var r = Math.atan2(ig.game.player.pos.y-this.pos.y, ig.game.player.pos.x-this.pos.x);
        ...
        this.vel.x = velx;
        this.vel.y = vely; */
     /*   if (this.distanceTo(this.spotted) <= this.viewDistance * 2) {
   ...
   /*     if (this.targetAngle < this.spotted.angle - 10 && this.targetAngle > this.spotted.angle + 10) {
    ...
    /*    if (this.sheepRunSoundPlaying === false) {
            this.sheepRunSound.play();
            this.sheepRunSoundPlaying = true;
        } */
