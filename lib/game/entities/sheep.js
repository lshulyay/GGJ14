...
ig.global.EntitySheep = ig.Entity.extend({
    ...
    pickEscapeAngle: function() {
        console.log('pick escape angle');
        // Angle of player
        var spottedAngle = this.spotted.angle;
        this.targetAngle = ig.game.controller.randomFromTo(spottedAngle - 10, spottedAngle + 10);
    },
    ...
    check: function(other) {
        ...
        else if (other instanceof EntityPlayer && !other.isSheep) {
            this.pickEscapeAngle();
        }
        this.parent();
    },
