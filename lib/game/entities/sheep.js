...
ig.global.EntitySheep = ig.Entity.extend({
	...
	init: function(x, y, settings) {
        ...
        this.spookTimer = new ig.Timer(5);
    ...
    startRunning: function() {
        ...
        var rand = ig.game.controller.randomFromTo(5,8);
        this.spookTimer.set(rand);
    ...
    checkRunMovement: function() {
        ...
        if (this.spookTimer.delta() > 0 || !this.spotted) {
            this.checkSpook();
        }
    },
    ...
    kill: function() {
        this.sheepRunSound.stop();
        var rand = ig.game.controller.randomFromTo(0, ig.game.sheepSplatSoundsArr.length - 1);
        var sound = ig.game.sheepSplatSoundsArr[rand];
        sound.play();
    ...
    goToRandomPos: function() {
        this.pos.x = ig.game.controller.randomFromTo(200, ig.system.width - 50);
        this.pos.y = ig.game.controller.randomFromTo(50, ig.system.height - 50);
    },
