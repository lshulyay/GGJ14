...
ggj14 = ig.Game.extend({
	...
	// Some audio
	themeMusic: new ig.Sound( 'media/audio/thememusic.*', false ),
	...
	init: function() {
		...
		// Add music
		ig.music.add( this.themeMusic, 'thememusic' );
		ig.music.loop = true;
		ig.music.volume = 0.4;
	...
	drawHUDbg: function() {
		...
		this.ctx.fillRect(0, 0, ig.system.width, 50);
	},
    ...
    drawEnergyBar: function() {
        ...
        this.ctx.fillRect(x, y, ig.game.player.energy * 3, 30);
        this.ctx.font = ig.game.mainhudFont;
        this.ctx.textBaseline = 'top';
        x = ig.system.width / 2;
        this.ctx.textAlign = 'center';
        this.ctx.fillStyle = '#fff';
        this.ctx.fillText('Energy: ' + ig.game.player.energy, x, y);
        this.ctx.restore();
    },
